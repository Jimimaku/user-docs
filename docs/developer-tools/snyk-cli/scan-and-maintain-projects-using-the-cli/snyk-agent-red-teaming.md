...
Use one of the following methods to install the Snyk CLI. For more installation options and troubleshooting, see the [Snyk CLI documentation](https://docs.snyk.io/snyk-cli).
